...
if (!isset($_GET["id"])) {
    header("Location: ../productpagina.php?message=Geen thema ID opgegeven.");
    exit;
}
...
if ($theme == null) {
    header("Location: admin.php?message=Thema niet gevonden.");
    exit;
}
...
if (isset($_POST["ja"])) {
    $theme->delete();
    header("Location: admin.php?message=Thema succesvol verwijderd.");
    exit;
}
